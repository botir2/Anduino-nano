...
/********************************************SD card and bluetooth manipulation fuction*******************************************/ 
       ...
       if (digitalRead(BTpin)==HIGH){         
        ...
        SDCARD_W(activity, String(q.w), String(q.x), String(q.y), String(q.z), realGyro.x, realGyro.y, realGyro.z, aa.x, aa.y, aa.z);  
       }  
...
void SDCARD_W (int activity, String(q_w), String(q_x), String(q_y), String(q_z), int gy_x, int gy_y, int gy_z, int acc_x, int acc_y, int acc_z)
{
        ...
        timer = millis(); // reset the timer
            ...
            i++;
             if(i == 10 ) {
               ...
               if(GapSumm >= 0 && GapSumm <= 200) { stand++; activity = 2; ActivitySetColor(10, 10, 10); } //standing
               if(GapSumm > 200 && GapSumm <= 800) { activity = 1; stand = 0; ActivitySetColor(0, 0, 25); } //walking
               if(GapSumm > 800)  {activity = 0; stand = 0; ActivitySetColor(0, 25, 0); } //running
