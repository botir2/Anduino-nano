...
/********************************************SD card and bluetooth manipulation fuction*******************************************/   
       ...
       if (digitalRead(BTpin)==HIGH){ 
               Serial.println(F("--- start read ---"));             
                   if (SD.exists("test_2.txt")) {
                    ...
                    int sdMonth = myFile.parseInt();
                    int sdDMonth = myFile.parseInt();
                    int sdHour = myFile.parseInt();
                    int sdminutes = myFile.parseInt();
                    int sdseconds = myFile.parseInt();
                    
                       String data_to_ras = "[" + String(sdacc_x) + "," + String(sdacc_y) + "," + String(sdacc_z) + "," + String(sdgy_x) + "," + String(sdgy_y) + "," + String(sdgy_z) + "," + String(sdYear)+ "," + String(sdMonth)+ "," + String(sdDMonth)+ "," + String(sdHour)+ "," + String(sdminutes)+ "," + String(sdseconds) + "," + String("run") + "]\n";
       ...
       else{Serial.println(F("--- start write ---")); SDCARD_W(accelerometer_x, accelerometer_y, accelerometer_z, gy_x, gy_y, gy_z, my_rtc.year, my_rtc.month, my_rtc.dayofmonth, my_rtc.hours, my_rtc.minutes, my_rtc.seconds);}
