...
//            Serial.println(aa.z);
       ...
       if (digitalRead(BTpin)==HIGH){         
                   ...
                   myFile = SD.open("test_2.csv"); // open "file.csv" to read data
                     ...
                     while((myFile.available() != -1) && (myFile.available()>0)){
                         ...
                         mySerial.print("[" + sdgy_x + "," + sdgy_y + "," + sdgy_z + "," + sdacc_x + "," + sdacc_y + "," + sdacc_z + "," +  sdYears + "," +  sdMonth + "," +  sdDMonth + "," +  sdHours + "," +  sdMins + "," +  sdSec + "]\n");
                         delay(500);    
                     } // close the file:
                     myFile.close();
      ...
      //delay(100);
        ...
        SDCARD_W( realGyro.x, realGyro.y, realGyro.z, aa.x, aa.y, aa.z, GapSumm);
...
void SDCARD_W (int gy_x, int gy_y, int gy_z, int acc_x, int acc_y, int acc_z, int GapSum)
{
        ...
        timer = millis(); // reset the timer
            ...
            i++;
             if(i == 10 ) {
               ...
               if(GapSumm >= 0 && GapSumm <= 200) { stand++; if(stand >= 2){activity = 2; walk = 0; run = 0;}} //standing
               if(GapSumm > 200 && GapSumm <= 800) { walk++; if(walk >= 2){activity = 1; stand = 0; walk = 0; run = 0; rest = 0;}} //walking
               if(GapSumm > 800)  {run++; if(run >= 2){activity = 0; stand = 0; walk = 0; run = 0; rest = 0;}} //running
               if(stand >= 10) { activity = 3;} //resting
               i = 0;
//               rest = 0;
