               ...
               Serial.println(F("--- start read ---"));             
                   if (SD.exists("test_2.txt")) {
                    ...
                    int sdYear = myFile.parseInt();
                       ...
                       String data_to_ras = "[" + String(sdacc_x) + "," + String(sdacc_y) + "," + String(sdacc_z) + "," + String(sdgy_x) + "," + String(sdgy_y) + "," + String(sdgy_z) + "," + String(sdHour)+ "," + String(sdminutes)+ "," + String(sdseconds)+ "," + String(sdYear) + "]\n";
