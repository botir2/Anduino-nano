...
//            Serial.println(aa.z);
      ...
      //delay(100);
        ...
        SDCARD_W(String(ypr[1] * 180/M_PI), String(ypr[2] * 180/M_PI), realGyro.x, realGyro.y, realGyro.z, aa.x, aa.y, aa.z);
...
void SDCARD_W (String pitch, String row, int gy_x, int gy_y, int gy_z, int acc_x, int acc_y, int acc_z)
{
