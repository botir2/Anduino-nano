...
//            Serial.println(ypr[2] * 180/M_PI);
      ...
      if (mySerial.available()){char inChar = (char)mySerial.read();
          ...
          else if(inChar == '1'){HealthSetColor(25,75,0);}
      }
//   
        ...
        timer = millis(); // reset the timer
            ...
            i++;
             if(i == 10 ) {
               ...
               GapYaw = MaxRoll - MinRoll;
               if(rest == 10) { activity = 3; ActivitySetColor(10, 10, 10);  GapRoll = -1; stand = 0; walk = 0; run = 0;} //resting
               if((GapRoll>=0 && GapRoll <=10) && (GapYaw>=0 && GapYaw <=10)) { stand++; if(stand >= 2){activity = 2; stand = 0; walk = 0; run = 0; ActivitySetColor(0, 25, 0); }} //standing
               ...
               if(GapRoll >= 40 && GapYaw >= 40)  {run++; if(run >= 2){activity = 0; stand = 0; walk = 0; run = 0; ActivitySetColor(25, 0, 0); }} //running
               i = 0;
               rest = 0;
             }
             delay(98);
