       ...
       if (digitalRead(BTpin)==HIGH){         
                   ...
                   myFile = SD.open("test_2.csv"); // open "file.csv" to read data
                     ...
                     while((myFile.available() != -1) && (myFile.available()>0)){
                         ...
                         mySerial.print("[" + sdgy_x + ","  + sdgy_y + ","+ sdgy_z + "," + sdacc_x + ","+ sdacc_y + "," + sdacc_z + "," + sdYears + "," + sdDMonth + "," + sdHours + "," + sdMins + "," + sdSec + "]\n");
                     ...
                     delay(100);
                        ...
                        if (BLtimer > millis())  BLtimer = millis();
                          if (millis() - BLtimer > 5000) {
                           ...
                           mySerial.print("["+ String("ADAAS") + "," + String(realGyro.y) + "," + String(realGyro.z) + "," + String(aa.x) + "," + String(aa.y) + "," + String(aa.z) + "]\n");
                          }
                   }
