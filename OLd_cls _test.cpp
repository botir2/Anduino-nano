...
int chipSelect = 9;
int16_t gy_x,gy_y,gy_z ; //acc, gyro data 
...
gyy[i] = gy_y;
 ...
 if(i == 8 ) {
  ...
  Gapgy = Maxgy - Mingy;
  if(sleep == 8) { Gapgy = -1; setColor(1, 1, 1);}//sleeping
  if(Gapgy >= 45000 ) {setColor(25, 0, 0);}//running
  if(Gapgy <45000 && Gapgy >12500) {setColor(0, 25, 0);}//walking
  if(Gapgy>0 && Gapgy <=12500) {setColor(0, 0, 25);}//standing
  i = 0;
  sleep = 0;
  } 
